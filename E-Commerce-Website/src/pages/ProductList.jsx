      ...
      <div className="row">
        {filtered.length > 0 ? (
          filtered.map((p) => {
            ...
            const discount = p.discount ?? Math.floor(Math.random() * 40) + 10; // 10% to 50%
            const discountedPrice = originalPrice - (originalPrice * discount) / 100;

            const rating = p.rating || (Math.random() * 1.5 + 3.5); // Dummy rating: 3.5 to 5
                ...
                >
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      {discount > 0 && (
                        <>
                          <del className="text-muted ms-2">₹{originalPrice}</del>{" "}
                          <span className="text-success ms-1">({discount}% OFF)</span>
                        </>
                      )}
                    </p>
